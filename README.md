# <img height=34 src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Hand%20gestures/Waving%20Hand.png"/> Awesome-Vision2Audio
A curated list of Vision to Audio Generation
...
**Tags:** 🔉 general audio / sound effects · 🎶 music · 📊 benchmark / evaluation

### 2026
- 2026 Aug. 🔉 HarmoniDPO: Video-guided Audio Generation via Preference-Optimized Diffusion. [📄 Paper](https://arxiv.org/abs/2608.11913)
- 2026 Aug. 🎶 Dialogue-Aware Video-to-Music Generation Using Public Domain Film Collections. [📄 Paper](https://arxiv.org/abs/2608.11576)
- 2026 Aug. 🔉 Visual Representation Matters: Exploiting Temporal Differences in Video-to-Audio Generation. [📄 Paper](https://arxiv.org/abs/2608.04902)
- 2026 Jul. 🔉 Precise Video-to-Audio Generation with Cross-Modal Alignment in Latent Space, accepted to ECCV'26. [📄 Paper](https://arxiv.org/abs/2607.06405)
- 2026 Jun. 🔉 FoleyGenEx: Unified Video-to-Audio Generation with Multi-Modal Control, Temporal Alignment, and Semantic Precision, accepted to INTERSPEECH'26. [📄 Paper](https://arxiv.org/abs/2606.14049)
- 2026 Jun. 🔉🎶 AudioX-Turbo: A Unified Framework for Efficient Anything-to-Audio Generation. [📄 Paper](https://arxiv.org/abs/2606.12555)
- 2026 Jun. 🔉 SMC-ITA: Sequential Monte Carlo Inference-Time Alignment for Video-to-Audio Generation. [📄 Paper](https://arxiv.org/abs/2606.08393)
- 2026 Jun. 🔉 Audio Imitator: Controlling Timbre and Tempo in Video2Audio Synthesis with Audio Reference. [📄 Paper](https://arxiv.org/abs/2606.07182)
- 2026 May. 🔉📊 Benchmarking Single-Factor Physical Video-to-Audio Generation, CVPR'26. [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Benchmarking_Single-Factor_Physical_Video-to-Audio_Generation_CVPR_2026_paper.html)
- 2026 Apr. 🎶 Video-Robin: Autoregressive Diffusion Planning for Intent-Grounded Video-to-Music Generation. [📄 Paper](https://arxiv.org/abs/2604.17656)
- 2026 Apr. 🔉 ControlFoley: Unified and Controllable Video-to-Audio Generation with Cross-Modal Conflict Handling. [📄 Paper](https://arxiv.org/abs/2604.15086)
- 2026 Apr. 🔉🎶📊 VidAudio-Bench: Benchmarking V2A and VT2A Generation across Four Audio Categories. [📄 Paper](https://arxiv.org/abs/2604.10542)
- 2026 Apr. 🔉 OmniSonic: Towards Universal and Holistic Audio Generation from Video and Text, CVPR'26. [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pian_OmniSonic_Towards_Universal_and_Holistic_Audio_Generation_from_Video_and_CVPR_2026_paper.html)
- 2026 Mar. 🔉 FoleyDirector: Fine-Grained Temporal Steering for Video-to-Audio Generation via Structured Scripts, CVPR'26. [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_FoleyDirector_Fine-Grained_Temporal_Steering_for_Video-to-Audio_Generation_via_Structured_Scripts_CVPR_2026_paper.html)
- 2026 Mar. 🔉 AC-Foley: Reference-Audio-Guided Video-to-Audio Synthesis with Acoustic Transfer, ICLR'26. [📄 Paper](https://iclr.cc/virtual/2026/poster/10009224)
- 2026 Mar. 🔉 V2A-DPO: Omni-Preference Optimization for Video-to-Audio Generation, accepted to ICASSP'26. [📄 Paper](https://arxiv.org/abs/2603.11089)
- 2026 Mar. 🎶 V2M-Zero: Zero-Pair Time-Aligned Video-to-Music Generation. [📄 Paper](https://arxiv.org/abs/2603.11042)
- 2026 Feb. 🔉 Echoes Over Time: Unlocking Length Generalization in Video-to-Audio Generation Models, CVPR'26. [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Simon_Echoes_Over_Time_Unlocking_Length_Generalization_in_Video-to-Audio_Generation_Models_CVPR_2026_paper.html)
- 2026 Jan. 🔉 Omni2Sound: Towards Unified Video-Text-to-Audio Generation, CVPR'26. [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dai_Omni2Sound_Towards_Unified_Video-Text-to-Audio_Generation_CVPR_2026_paper.html)
...
- 2025 🔉 OmniAudio: Generating Spatial Audio from 360-degree Video, ICML'25
...
- 2025 🔉 Tri-Ergon: Fine-grained Video-to-Audio Generation with Multi-modal Conditions and LUFS Control, AAAI'25
- 2025 🔉 PrismAudio: Decomposed Chain-of-Thought and Multi-dimensional Rewards for Video-to-Audio Generation, ICLR'26
- 2025 🔉 DreamFoley: Scalable VLMs for High-Fidelity Video-to-Audio Generation
- 2025 🔉 MGAudio: Model-Guided Dual-Role Alignment for High-Fidelity Open-Domain Video-to-Audio Generation, NeurIPS'25
- 2025 🔉 FoleyGRAM: Video-to-Audio Generation with GRAM-Aligned Multimodal Encoders, IJCNN'25
- 2025 🔉 Hear What Matters! Text-conditioned Selective Video-to-Audio Generation, CVPR'26
- 2025 🔉 MFM-Mapper: Efficient Video-to-Audio Generation via Multiple Foundation Models Mapper
- 2025 🔉 SpecMaskFoley: Steering Pretrained Spectral Masked Generative Transformer Toward Synchronized Video-to-Audio Synthesis via ControlNet, WASPAA'25
- 2025 🔉 StereoFoley: Object-Aware Stereo Audio Generation from Video, ICASSP'26
- 2025 🔉 MMAudioSep: Taming Video-to-Audio Generative Model towards Video/Text-Queried Sound Separation, ICASSP'26
- 2025 🔉 MDG: Training-Free Multimodal Guidance for Video to Audio Generation, ICASSP'26
...
- 2025 🎶 GVMGen: A General Video-to-Music Generation Model with Hierarchical Attentions, AAAI'25
- 2025 🔉🎶 AudioX: A Unified Framework for Anything-to-Audio Generation, ICLR'26
...
### 2024
- 2024  🎶 VMAs: Video-to-Music Generation via Semantic Alignment in Web Music Videos, ByteDance, WACV'25. [🌐 Demo](https://genjib.github.io/project_page/VMAs/index.html)
- 2024  🎶 MM-LDM: Multi-Modal Latent Diffusion Model for Sounding Video Generation, Institute of automation, MM'24
- 2024 Jul. 🔉 FoleyCrafter: Bring Silent Videos to Life with Lifelike and Synchronized Sounds. Shanghai Artificial Intelligence Laboratory, Chinese University of Hong Kong, Shenzhen. IJCV'26. [🌐 Demo](https://foleycrafter.github.io/) [🔗 Code](https://github.com/open-mmlab/FoleyCrafter) [🤗 HF](https://huggingface.co/ymzhang319/FoleyCrafter) Datasets (VGGSound, AVSync15)
- 2024 Jul. 🔉 FRIEREN: Efficient Video-to-Audio Generation Network with Rectified Flow Matching. ZheJiang University. NeurIPS'24. [🌐 Demo](https://frieren-v2a.github.io/) Datastes (VGGSound)
...
- 2024 Jul. 🔉 Read, Watch and Scream! Sound Generation from Text and Video, NAVER. AAAI'25. [🌐 Demo](https://naver-ai.github.io/rewas/) Datastes (VGGSound)
- 2024 June. 🎶 VidMuse: A Simple Video-to-Music Generation Framework with Long-Short-Term Modeling, HKUST, Microsoft Research Asia, CVPR'25. [🔗 Code](https://github.com/ZeyueT/VidMuse/) Datasets (V2M).
...
- 2024 🎶 Video2Music: Suitable music generation from videos using an Affective Multimodal Transformer model, SUTD, Expert Systems with Applications, vol. 249 (2024). [🔗 Code](https://github.com/AMAAI-Lab/Video2Music). Datasets (MuVi-Sync)
...
- 2024 🔉 Video-Foley: Two-Stage Video-To-Sound Generation via Temporal Event Condition For Foley Sound, KAIST, IEEE TASLPRO'25. [🌐 Demo](https://jnwnlee.github.io/video-foley-demo/)
- 2024 🔉 LoVA: Long-form Video-to-Audio Generation, RUC, ICASSP'25. Datasets(AudioSet, VGGSound, UnAV100)
...
- 2023 Jun. 🔉 DiffFoley: Synchronized Video-to-Audio Synthesis with Latent Diffusion Models, Tsinghua University, NeurIPS'23. [🌐 Demo](https://diff-foley.github.io/) [🔗 Code](https://github.com/luosiallen/Diff-Foley) Datasets (VGGSound, AudioSet)
...
- 2023 🔉 CMMD: Contrastive Multi-Modal Diffusion for Video-Audio Conditional Modeling, Microsoft, ECCV Workshops'24
...
- 2020 Jul. 🎶 Foley Music: Learning to Generate Music from Videos, MIT, ECCV'20.
- 2020 Jun. 🎶 Audeo: Audio Generation for a Silent Performance Video, University of Washington, NeurIPS'20.
...
- 2025 Mar. A Survey on Vision-to-Music Generation: Methods, Datasets, Evaluation, and Challenges, ISMIR'25. [🔗 Code](https://github.com/wzk1015/Awesome-Vision-to-Music-Generation).
